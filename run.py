...
os.system("python3 compute_certified_radius.py --k 30")
os.system("python3 compute_certified_radius.py --k 50")
os.system("python3 compute_certified_radius.py --k 100")
